...
export default {
  ...
  cargaOutros: 'Outro',
  cargaVolumeTitulo: 'Quanto é, mais ou menos?',
  cargaVolPequeno: 'Pequeno',
  cargaVolPequenoNota: 'Cabe no banco de trás de um carro',
  cargaVolMedio: 'Médio',
  cargaVolMedioNota: 'Enche meia caixa do Carry',
  cargaVolGrande: 'Grande',
  cargaVolGrandeNota: 'Enche a caixa do Carry',
  ...
  cargaNotasExemplo: 'Ex.: recolher na loja · entregar no 2.º andar · carga frágil',
  cargaDeclaracao: 'Confirmo que os bens são legais, seguros e cabem na capacidade do veículo.',
  cargaFotosTitulo: 'Fotografias dos bens',
  cargaFotosNota: 'Ajuda o motorista a saber se cabe. Até 3.',
