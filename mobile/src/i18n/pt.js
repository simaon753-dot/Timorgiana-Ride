...
export default {
  ...
  cargaTitulo: 'O que pretende transportar?',
  ...
  cargaVolGrandeNota: 'Ocupa grande parte da caixa do Carry',
  ...
  cargaFotoTirar: 'Tirar fotografia',
  cargaFotoRemover: 'Remover',
  cargaFotosDoPedido: 'Fotografias',
  ...
  carryModoTitulo: 'O que vai no Carry?',
  carryModoBens: 'Bens',
  ...
  errCarroceriaCapacidade: 'Escolha a carroçaria e a capacidade do Carry.',
  capacidadeFaltaTitulo: 'Indique a capacidade do seu Carry',
  ...
  rotuloAno: 'Ano',
  admSecCarry: 'Carry',
  admCarryEstado: 'Serviço Carry',
  admCarryLigado: 'Ligado',
  admCarryDesligado: 'Desligado',
  admCarryEstadoNota:
    'Desligado, o Carry aparece como indisponível na app e não aceita pedidos novos. As viagens a decorrer continuam.',
  admCarryConfirmarDesligar: 'Os passageiros deixam de poder pedir Carry até o voltar a ligar.',
  admCarryConfirmarLigar: 'Os passageiros voltam a poder pedir Carry.',
  ...
  admCarryMotoristas: 'Motoristas Carry por capacidade',
  admCarrySemCapacidade: 'Capacidade por indicar',
  admCarrySemMotoristas: 'Ainda não há motoristas Carry aprovados.',
  admCarryOnline: '{n} online',
  admCarryPrecos: 'Preços do Carry',
