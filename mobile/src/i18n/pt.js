...
export default {
  ...
  admVerConversa: "Ler a conversa ({n})",
  admSemConversa: "Sem mensagens",
  admConversaAviso: "Esta leitura fica registada",
  admConversaTitulo: "Ler esta conversa?",
  admConversaExplica: "É uma conversa privada entre duas pessoas. A leitura fica registada com o teu nome e a data.",
  admLer: "Ler",
  admCodigoRecolha: "Código de recolha",
  admPedida: "Pedida",
  admComecou: "Começou",
  admRegistoTitulo: "Quem leu o quê",
