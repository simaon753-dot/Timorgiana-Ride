...
export default {
  ...
  assinPasso3: '3. Envie o comprovativo',
  assinReferenciaRotulo: 'Escreva sempre esta referência na descrição do pagamento:',
  assinValorAPagar: 'Valor a pagar',
  assinEscolherComprovativo: 'Escolher o comprovativo',
  assinTrocarComprovativo: 'Trocar o comprovativo',
  assinEnviarPedido: 'Enviar pedido',
  assinFaltaAlgo: 'Escolha o pacote, a forma de pagamento e o comprovativo.',
  assinPedidoEnviado:
    'Pedido enviado. Os dias entram quando confirmarmos o pagamento, no máximo em {h} horas.',
  assinEsperaTitulo: 'Pagamento à espera de confirmação',
  assinEsperaTexto:
    'Os dias entram quando confirmarmos que o pagamento chegou — no máximo {h} horas depois do envio.',
  ...
  assinDevolucoes: 'Devoluções',
  admSecPagamentos: 'Pagamentos',
  admNotifPagamentos: 'Pagamentos por confirmar',
  admNotifPagamentosAtrasados: 'Pagamentos à espera há mais de 24 horas',
  admPagPorConfirmar: 'Pagamentos por confirmar',
  admPagNota:
    'Confirme no extracto do banco a referência e o valor. O comprovativo, sozinho, não basta.',
  admPagVazio: 'Nenhum pagamento à espera.',
  admPagHa: 'há {h} h',
  admPagConfirmar: 'Confirmar',
  admPagConfirmarPergunta:
    'Encontrou no extracto ${valor} com a referência {ref}? Os {dias} dias entram na conta de {nome}.',
  admPagRecusar: 'Recusar',
  admPagMotivo: 'Motivo da recusa',
  admPagMotivoNaoEncontrado: 'Pagamento não encontrado no extracto',
  admPagMotivoValor: 'Valor diferente do pacote',
  admPagMotivoReferencia: 'Referência em falta ou errada',
  admPagMotivoIlegivel: 'Comprovativo ilegível',
  admPagOutroMotivo: 'Ou escreva o motivo',
  admPagConfirmarRecusa: 'Recusar pagamento',
  admPagDecididos: 'Decididos recentemente',
  admPagConfirmado: 'Confirmado',
  admPagRecusado: 'Recusado',
  admPagCancelado: 'Cancelado',
  admPagFormas: 'Formas de pagamento',
  admPagFormasNota:
    'O que escrever aqui é o que o motorista vê: número de conta, titular, morada. Uma forma ligada precisa de instruções.',
  admPagLigada: 'Ligada',
  admPagDesligada: 'Desligada',
  admPagInstrucoes: 'Instruções para o motorista',
  admPagGuardar: 'Guardar formas de pagamento',
  admPagGuardado: 'Guardado.',
  admReferencia: 'Referência',
  admDevCalcular: 'Calcular devolução',
  admDevResultado: '{dias} dias por usar · ${valor} a devolver',
  admDevParte: '{dias} dias × ${porDia} (carregados a {quando})',
  admDevOferecidos: '{n} dias oferecidos não se devolvem.',
  admDevMotivoEncerramento: 'Conta encerrada a pedido',
  admDevMotivoDesativacao: 'Desativada pela plataforma',
  admDevMotivoFim: 'Fim do serviço',
  admDevNota: 'Na desativação por falta grave não há devolução: não registe.',
  admDevRegistar: 'Registar devolução',
  admDevConfirmar:
    'Registar a devolução de ${valor} ({dias} dias)? O saldo passa a zero; o dinheiro é devolvido por fora.',
  admDevSemDias: 'Esta conta não tem dias por usar.',
  ...
  cor_lilas: 'Lilás',
  cor_roxo: 'Roxo',
  cor_azulclaro: 'Azul-claro',
  cor_azulescuro: 'Azul-escuro',
  cor_turquesa: 'Turquesa',
  cor_verdeclaro: 'Verde-claro',
  cor_verdeescuro: 'Verde-escuro',
  cor_oliva: 'Verde-oliva',
  cor_grafite: 'Grafite',
  cor_outra: 'Outra',
  ...
  admXdeYAceites: '{x} de {y} viagens aceites',
  admSemMotorista: 'Sem motorista',
  admNotaSemMotorista: 'Pedidos que ninguém aceitou',
  ...
  carryBensSub: 'Compras, móveis, caixas, mercadorias e mudanças de casa',
  ...
  encomendaNota: 'Alguém compra por si e entrega',
  encomendaExplica:
    'O motorista compra com o dinheiro dele e entrega-lhe. Paga em mão: a viagem e as compras.',
  encomendaLista: 'O que comprar',
  encomendaListaExemplo: 'Ex.: 2 kg de arroz, 1 garrafa de óleo, pão',
  encomendaTeto: 'Até quanto pode gastar',
  encomendaTetoNota:
    'O motorista não gasta mais do que isto. Se faltar alguma coisa, fala consigo.',
  encomendaTaxa: 'Serviço de compra: {v}',
  encomendaTaxaRotulo: 'Serviço de compra',
  encomendaTaxaNota: 'Soma-se à viagem. Se gastar menos, paga menos.',
  encomendaFaltam: 'Para encomendar, faça primeiro {n} viagens. Já tem {feitas}.',
  encomendaOndeComprar: 'Onde comprar',
  encomendaOndeEntregar: 'Onde entregar',
  encomendaContinuar: 'Continuar',
  encomendaSemLista: 'Escreva o que quer que o motorista compre.',
  encomendaArtigos: 'O que comprar',
  encomendaArtigoNome: 'Artigo',
  encomendaArtigoExemplo: 'Ex.: Arroz',
  encomendaArtigoQuantos: 'Quantos',
  encomendaArtigoDetalhe: 'Marca ou tamanho',
  encomendaArtigoDetalheExemplo: 'Ex.: Bola Mas, 5 kg',
  encomendaJuntarArtigo: 'Juntar artigo',
  encomendaRetirarArtigo: 'Retirar artigo',
  encomendaMaxItens: 'Uma encomenda leva até {n} artigos.',
  encomendaLojaNome: 'Nome da loja',
  encomendaLojaExemplo: 'Ex.: Kmanek de Comoro',
  encomendaLojaPonto: 'Onde fica',
  encomendaFoto: 'Fotografia do produto',
  encomendaFotoNota: 'Opcional, mas evita enganos: o motorista compra o que vê.',
  encomendaFotoJuntar: 'Juntar fotografia',
  encomendaEmailFalta: 'Confirme o seu email no perfil antes de encomendar.',
  encomendaIrPerfil: 'Ir ao perfil',
  encomendaResumo: 'Encomenda',
  encomendaEditar: 'Alterar',
  encomendaIndisponivel: 'A encomenda não está disponível neste momento.',
  encomendaAteGastar: 'Até {v}',
  encomendaJaComprei: 'Já comprei',
  encomendaQuantoGastou: 'Quanto gastou?',
  encomendaValor: 'Valor do talão',
  encomendaTalao: 'Fotografia do talão',
  encomendaTalaoNota: 'Fica com a viagem e serve de prova se houver dúvida.',
  encomendaGuardar: 'Guardar compra',
  encomendaGuardada: 'Compra registada.',
  encomendaCompras: 'Compras',
  encomendaTotal: 'Total a pagar',
  encomendaComprou: 'O motorista já comprou. Prepare {v} em dinheiro.',
  encomendaTotalNota: 'Viagem mais compras, em dinheiro.',
  encomendaAcimaDoTeto: 'O passageiro autorizou até {v}.',
};
