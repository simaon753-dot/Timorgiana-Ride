...
export default {
  ...
  assinGratuitaExplica: 'To’o data ne’e ita la selu buat ida no la bloqueia. Loron sira rejistu hela atu ita bele haree oinsá mak funsiona.',
  assinSaldo: 'Loron iha ita-nia saldu',
  assinDias: 'loron',
  assinSemSaldo: 'La iha loron. Karga atu bele simu fali viajen.',
  assinRegra: 'Loron ida sura de’it bainhira ita remata viajen ida ka liu. Loron ne’ebé la iha viajen la deskonta buat ida, no viajen sanulu iha loron hanesan sura nafatin hanesan loron ida.',
  assinPacotes: 'Pakote sira',
  assinComoPagar: 'Oinsá karga',
  assinComoPagarNota: 'Depois selu ona, fó hatene ami ho komprovativu. Loron sira tama iha ita-nia konta bainhira ami konfirma.',
