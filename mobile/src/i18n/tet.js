...
export default {
  ...
  admStatusSuspended: 'Suspende',
  admTripsCount: 'viajen {n}',
  admCancelled: 'kansela {n}',
  admPhotoToday: 'Foto ohin',
  admPhotoMissing: 'La iha foto ohin',
  admDocsUntil: 'Dokumentu toʼo {data}',
  admExpiringSoon: 'Dokumentu sei remata',
  admNoRides: 'La iha viajen iha tempu neʼe.',
  admWaitTime: 'Tempu média toʼo simu',
  admNoAnswer: 'Pedidu la iha resposta',
  ...
  admProcurar: "Buka ho naran ka telefone",
  admSemResultados: "La hetan konta ida.",
  admMais: "Hatudu tan",
  ...
  admUltimaVez: "Haree ikus",
  admTermos: "Simu termu",
  admTermosNao: "Seidauk simu",
  admDecisao: "Desizaun",
  admHistorico: "Viajen sira",
  admAvaliacoesRecebidas: "Avaliasaun simu",
  admTurnosFoto: "Foto turnu nian",
  admEmergencias: "Emerjénsia",
  admVerConversa: "Lee konversa ({n})",
  admSemConversa: "Mensajen laiha",
  admConversaAviso: "Leitura ne'e rejistu",
  admConversaTitulo: "Lee konversa ne'e?",
  admConversaExplica: "Ne'e konversa privadu entre ema rua. Leitura sei rejistu ho ita-nia naran no data.",
  admLer: "Lee",
  admCodigoRecolha: "Kódigu foti",
  admPedida: "Husu iha",
  admComecou: "Hahú iha",
  admRegistoTitulo: "Sé mak lee saida",
  admRegistoVazio: "Laiha asesu rejistadu.",
