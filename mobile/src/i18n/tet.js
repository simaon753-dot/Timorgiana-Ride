...
export default {
  ...
  cargaOutros: 'Seluk',
  cargaVolumeTitulo: 'Boot hira, maizumenus?',
  cargaVolPequeno: 'Kiik',
  cargaVolPequenoNota: 'Tama iha kareta nia kadeira kotuk',
  cargaVolMedio: 'Klaran',
  cargaVolMedioNota: 'Nakonu Carry nia kaixa balun',
  cargaVolGrande: 'Boot',
  cargaVolGrandeNota: 'Nakonu Carry nia kaixa tomak',
