...
export const termosMotorista = {
  ...
  seccoes: [
    ...
    },
    {
      ...
      texto:
        'O passageiro paga-lhe em dinheiro, no final da viagem. Não cobramos qualquer comissão nesta fase inicial: numa viagem de $3, fica com os $3. Se no futuro for introduzida alguma taxa de serviço, será avisado com antecedência e ficará inteiramente livre de deixar de utilizar a plataforma. O preço é fixado pela aplicação e não se negoceia com o passageiro – é essa transparência que gera confiança no serviço.',
    },
    {
