// Aviso de privacidade — três idiomas.
//
// Texto português e tétum escritos pelo Simão (jurista), 29-08-2026.
// Inglês traduzido a partir do português, que PREVALECE em caso de
// dúvida — é o que passou pela revisão jurídica.
//
// Fica em ficheiro próprio e não junto aos termos, porque tem vida
// diferente: as lojas exigem que este texto esteja publicado num
...
const pt = {
  ...
  seccoes: [
    ...
    },
    {
      ...
      texto:
        'Os dados podem ser tratados por fornecedores situados noutros países. Quando isso ocorrer, aplicaremos as salvaguardas exigidas pela lei aplicável. Podemos atualizar este aviso; avisaremos na aplicação quando a alteração for material e, se necessário, pediremos novo consentimento.',
    },
    {
...
const en = {
  ...
  seccoes: [
    ...
    },
    {
      ...
      texto:
        'Data may be processed by suppliers located in other countries. Where that occurs, we will apply the safeguards required by the applicable law. We may update this notice; we will give notice in the application where the change is material and, if necessary, will ask for fresh consent.',
    },
    {
...
export function textoPrivacidade(lang) {
